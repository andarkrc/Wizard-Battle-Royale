...
part_type_size(pt_cloud, 0.5, 1.5, 0.02, 0);
part_type_color2(pt_cloud, c_fuchsia, c_purple);
part_type_alpha3(pt_cloud, 0.8, 0.5, 0);
part_type_life(pt_cloud, 30, 50);
part_type_direction(pt_cloud, 0, 360, 0, 0);
part_type_speed(pt_cloud, 0.5, 2, -0.02, 0);
